...
## [2.59.0](https://github.com/KyberDot/comet/compare/v2.58.0...v2.59.0) (2026-07-29)
...
* add INDEXER_LANGUAGES setting for multi-language title support ([426a74b](https://github.com/KyberDot/comet/commit/426a74b8d68c45179cfef8d19b9bd2ade66ca113))
...
* **background-scraper:** add graceful stop after current run ([ed9403d](https://github.com/KyberDot/comet/commit/ed9403d829d12995e1df2165ff59d3a86360f6f0))
* **background-scraper:** add graceful stop after current run ([afa3de2](https://github.com/KyberDot/comet/commit/afa3de2e4f60d10266cd3d9daa7cb7b5bfb7140c))
* **background-scraper:** enhance drain endpoint for graceful stop and idempotency ([e391e10](https://github.com/KyberDot/comet/commit/e391e10f247157289850ec313ea19099cfcd7f2b))
* **cloudflare:** add Torznab cache rule for improved feed caching ([bd375e7](https://github.com/KyberDot/comet/commit/bd375e7975902934c44d48104f5a04ae28cf5f37))
...
* **dependencies:** add dev dependency group for pytest ([a78841e](https://github.com/KyberDot/comet/commit/a78841e68d465b2bcf88a9085b2851d3ea4dd24c))
* **discovery:** optimize peer validation process and enhance snapsho… ([28d4371](https://github.com/KyberDot/comet/commit/28d4371e5e1526a7d192d0549a5f2fa4c5600918))
* **discovery:** optimize peer validation process and enhance snapshot handling during discovery updates ([fc92860](https://github.com/KyberDot/comet/commit/fc92860906fa994d9391e34df9117cce1087ca4b))
* **docker:** update Dockerfile to use slim images and improve package installation ([403b1dc](https://github.com/KyberDot/comet/commit/403b1dc1fe8fc299e010385b1ed0945def0177ab))
...
* enhance debrid account cleanup with provider filtering and anime type resolution ([d2b2a77](https://github.com/KyberDot/comet/commit/d2b2a77618277c3dd573c08bd1636bd678da9695))
...
* enhance indexer title search with canonical and original title options ([52c51fd](https://github.com/KyberDot/comet/commit/52c51fd6243cfa93a8670bb255b253682de0e81a))
...
* Enhance TMDB integration and remove Trakt dependency ([24238ed](https://github.com/KyberDot/comet/commit/24238ed0234ea539364f4984fbe7e4e4e894f516))
...
* **healthcheck:** implement healthcheck module and update Dockerfile for healthcheck command ([be7e691](https://github.com/KyberDot/comet/commit/be7e6911282ecf6ed611687c70279f52701d4820))
* **imdb:** enhance title matching to return nearest match for year ([1e5874e](https://github.com/KyberDot/comet/commit/1e5874ea755eda1969cdf9677ea133612f5a21c1))
* **imdb:** implement title lookup caching and upsert functionality ([c1d1766](https://github.com/KyberDot/comet/commit/c1d1766688549be6058523f6ebf686eb58af3153))
...
* implement debrid account cache cleanup functionality and related migrations ([1278146](https://github.com/KyberDot/comet/commit/1278146bd3a85935f8288a2c529544131a07f5ae))
...
* **log_levels:** add KODI custom log level ([25f3a53](https://github.com/KyberDot/comet/commit/25f3a53930410721d544eee3ae778e98ce55a97e))
* **media_search:** refine logging for series with season and episode ([19b6b02](https://github.com/KyberDot/comet/commit/19b6b023179007e60f386d68864a29417afc8291))
* **network:** add AIOStreams user IP header to proxy headers ([173296d](https://github.com/KyberDot/comet/commit/173296d7d839cbe997a2e97af3c96bd8c8645ddd))
* **observability:** add documentation for multi-replica Prometheus deployment ([6820e00](https://github.com/KyberDot/comet/commit/6820e0044fff3c4482af7610c0ce12f5c3ec3a4d))
* **observability:** add Grafana dashboard preview and image asset ([261da21](https://github.com/KyberDot/comet/commit/261da21ec80f1e8e9cd4fe4b4cbb6fc980a77ddf))
* **observability:** add Prometheus metrics and Grafana dashboards ([ed71812](https://github.com/KyberDot/comet/commit/ed7181227c0125e53b4a48c1a65f25a24ebf3595))
* **observability:** enhance Prometheus metrics authentication and update documentation for configuration ([3801780](https://github.com/KyberDot/comet/commit/38017809c3ff207ebafb417a084b68d5b61cb223))
* **observability:** refactor Prometheus integration and update Grafana dashboard queries ([73e5bb9](https://github.com/KyberDot/comet/commit/73e5bb91971731bf235563550bc03b57450aa796))
* **observability:** streamline Grafana admin password generation in Docker setup ([5a7d19a](https://github.com/KyberDot/comet/commit/5a7d19aab9ba21b45c9e358413645149e4b0bd66))
* **observability:** update Docker Compose instructions for Prometheus and Grafana setup ([f40ef95](https://github.com/KyberDot/comet/commit/f40ef9587b3511b67713b39e594459d5045eabe8))
...
* remove Latin diacritics from titles for improved indexer compatibility ([de8c8f8](https://github.com/KyberDot/comet/commit/de8c8f8441dff724ff7079ebbf9a1eef20c13ca5))
...
* **scraper:** add context-aware timeout policies ([07f6668](https://github.com/KyberDot/comet/commit/07f66689860d89687e8b6c72e251285a8d93d2f1))
* **scraper:** add context-aware timeout policies ([69b1f32](https://github.com/KyberDot/comet/commit/69b1f32daed02d683bec92241b9e019acb6041ea))
* **scraper:** enhance timeout resolution for indexer managers and add related tests ([dfad7b8](https://github.com/KyberDot/comet/commit/dfad7b85b828cfd2c5af4fe51a6098264b5cc7b3))
* **scraper:** include indexer name in tracker for StremthruScraper ([4e95961](https://github.com/KyberDot/comet/commit/4e959618204bbc1910feb57c6904d68af94eafee))
* **scraper:** measure and log response time in scrape wrapper and filter manager ([d2785c2](https://github.com/KyberDot/comet/commit/d2785c2a8441360f342374d98fbf3fe15cb2add3))
...
* **tests:** add StremthruScraper tests and TrashRankModel to CometSettingsModel ([bcdbdfc](https://github.com/KyberDot/comet/commit/bcdbdfc9b7708ed218c053e8247f55b7974d2660))
* **tests:** add test for Gunicorn control socket configuration ([907acc4](https://github.com/KyberDot/comet/commit/907acc4ed2626300c2226a463b5c3be8e88e7e8a))
* **tests:** add unit tests for template response handling in admin and config endpoints ([8eb98c5](https://github.com/KyberDot/comet/commit/8eb98c522384fc45fa3fa126d3d84c1fe70f5afc))
* **torrent:** enhance metadata broadcasting to skip invalid entries ([77bdada](https://github.com/KyberDot/comet/commit/77bdada7c79037d035647679ac27d7d132df90b4))
* **torznab:** add native Torznab search endpoint ([fa6da35](https://github.com/KyberDot/comet/commit/fa6da35233fc3c90e3dc13d71bd80ca0a69ac19e))
* **torznab:** add native Torznab search endpoint ([a49a41b](https://github.com/KyberDot/comet/commit/a49a41b99eec5108498cccd9af4e488e64e7a268))
* **torznab:** add Torznab client integration and update documentation ([c32f3cb](https://github.com/KyberDot/comet/commit/c32f3cbf0dbe7109b50526caa8bacd2f652b99f8))
* **torznab:** refactor magnet link generation and improve torrent serialization ([bf534dc](https://github.com/KyberDot/comet/commit/bf534dcc71898e7e5049c2e0f2e4114bdacc91be))
* **torznab:** update feed serialization to ignore offset and limit p… ([46a4ca3](https://github.com/KyberDot/comet/commit/46a4ca3eea34dc7c63f78d3cb3dedb3c4eeeab37))
* **torznab:** update feed serialization to ignore offset and limit parameters, enhance response structure ([c32729e](https://github.com/KyberDot/comet/commit/c32729e55691c5afe203698ab3335a12deaeed83))
...
* **admin:** harden live dashboard rendering ([4a98ae0](https://github.com/KyberDot/comet/commit/4a98ae07495cd0f85c674fc6480e56686dcceebe))
* **admin:** validate and coalesce update checks ([584c38b](https://github.com/KyberDot/comet/commit/584c38b8f0601a652fb4fcf73ca851a10a6f2915))
* **admin:** validate cached metrics ([149efa6](https://github.com/KyberDot/comet/commit/149efa6fc81e55d0cf8246955be4d769a5c03ad5))
...
* **anime:** handle list imdb_id from Fribb ([a26cc5c](https://github.com/KyberDot/comet/commit/a26cc5cd02f2ef2878ea47df1af949c6bde96e40))
* **anime:** own background refresh task ([f7084de](https://github.com/KyberDot/comet/commit/f7084de338283ffc3720fb02e225204f5103da93))
* **anime:** publish mapping atomically ([cd981bc](https://github.com/KyberDot/comet/commit/cd981bc1c90db99825b38df07d80043f9bda445d))
* **anime:** reload mapping caches atomically ([5ea0553](https://github.com/KyberDot/comet/commit/5ea055301f276c27a3205cc006f9e8e2bdc45704))
* **anime:** validate cached mapping data ([bc084ea](https://github.com/KyberDot/comet/commit/bc084ea3b05b1439d58696828d6604ea627a76aa))
* **auth:** enforce current signed session contract ([07f5861](https://github.com/KyberDot/comet/commit/07f5861f68ab9a5a7bfba733226360927130ec59))
* **background:** atomically requeue dead work ([b0accf6](https://github.com/KyberDot/comet/commit/b0accf6beb2dd9567e01e69e4a999fa776944976))
* **background:** calculate queue age from eligibility time ([9ed8119](https://github.com/KyberDot/comet/commit/9ed81191459e776e24f3b2734110988534578c9b))
* **background:** calculate queue age from eligibility time ([061091e](https://github.com/KyberDot/comet/commit/061091edd81f1d71b0c46951b5e7de5e4c48df34))
* **background:** finalize scraper lifecycle ([1a590a2](https://github.com/KyberDot/comet/commit/1a590a22cddc70ea2b4869725cbc336da6b59e9d))
* **background:** validate Cinemata discovery data ([9448c0b](https://github.com/KyberDot/comet/commit/9448c0bb5f0c87b8166d930f51465581b48595fa))
* **background:** validate status query schema ([7b58bed](https://github.com/KyberDot/comet/commit/7b58bedfc3a99fae22914d4a33e5484d93161c2c))
* **bandwidth:** complete shutdown lifecycle ([d9267cd](https://github.com/KyberDot/comet/commit/d9267cde3fda617a25d1efec37d6146661fe8bac))
* **cache:** await scrape queue handoff ([4c3108d](https://github.com/KyberDot/comet/commit/4c3108de81ece48b3eb41d8082fc68e52ffb5e1a))
* **cache:** isolate invalid parsed data ([efb99f8](https://github.com/KyberDot/comet/commit/efb99f860848ee7ffea93c48b778d3d8d03361c2))
* **cache:** preserve empty scrape retries and throttle demand writes ([0de0302](https://github.com/KyberDot/comet/commit/0de03023c0febff0cec59e5de57f823638c0bbfd))
* **chilllink:** improve media_id construction for series type ([9cb1a8a](https://github.com/KyberDot/comet/commit/9cb1a8af71c4d8a5292fae30333588771d1da0fe))
...
* **cometnet:** add end-to-end IPv6 support ([de1e381](https://github.com/KyberDot/comet/commit/de1e381ae353a6fc57f162332cd8cd8d9b65e3c7))
* **cometnet:** add end-to-end IPv6 support ([3eb9988](https://github.com/KyberDot/comet/commit/3eb9988a4cec56ed940a9d6adc713b3dc8235e15))
* **cometnet:** authenticate transport control frames ([efbe197](https://github.com/KyberDot/comet/commit/efbe1976ec8c5356aec671b31cf98952c856f2cf))
...
* **cometnet:** bind verified keys to handshakes ([229a775](https://github.com/KyberDot/comet/commit/229a7752660229fbc346a9b90e147e7db0e8ad68))
* **cometnet:** certify member departures ([8d896f9](https://github.com/KyberDot/comet/commit/8d896f9d18fac438b8a0ba7028832ee1574a5feb))
...
* **cometnet:** clean partial startup ([3831906](https://github.com/KyberDot/comet/commit/38319060a7a1e2c5a17af6966f538d1d55fd1584))
* **cometnet:** complete teardown after failures ([c922a9d](https://github.com/KyberDot/comet/commit/c922a9d9c14fc5596d4cfec35d0205549cb1beee))
...
* **cometnet:** drain relay sends on shutdown ([9977d0a](https://github.com/KyberDot/comet/commit/9977d0a98e0a2c70f0c90350543dddb9343b4d59))
* **cometnet:** enforce auxiliary state schema ([685a439](https://github.com/KyberDot/comet/commit/685a4395dc672d04a333af7b18a09a63d1230d30))
* **cometnet:** enforce current message schema ([a55b8e1](https://github.com/KyberDot/comet/commit/a55b8e19c17d3578cddefd24bbe49cf6815862ea))
* **cometnet:** enforce current pool authority ([9e1fa19](https://github.com/KyberDot/comet/commit/9e1fa1997af8e1c695485e2ada6e6a23f19e3001))
* **cometnet:** enforce discovery state schema ([52d41ec](https://github.com/KyberDot/comet/commit/52d41ecc433331598df66ee68778d3d7de557ab6))
* **cometnet:** enforce reputation state schema ([639367f](https://github.com/KyberDot/comet/commit/639367fe27c9a1dadadf9cda19ede95649908701))
* **cometnet:** enforce strict admin API contracts ([375c3c6](https://github.com/KyberDot/comet/commit/375c3c61324073b3602df6ef7b92220f94b118b9))
* **cometnet:** fail closed on message authentication ([277bdb2](https://github.com/KyberDot/comet/commit/277bdb2135f2e0dfde2ac13c5a77aa14ac04ead1))
* **cometnet:** handle IPv6 addresses in host formatting ([eefb140](https://github.com/KyberDot/comet/commit/eefb14076d547bb6522c9e38a23082518f4f63a5))
* **cometnet:** make contribution flush durable ([25ef574](https://github.com/KyberDot/comet/commit/25ef5747de16000b81e0a24ef4508c1427df97c4))
* **cometnet:** make peer cleanup identity safe ([d4b5b50](https://github.com/KyberDot/comet/commit/d4b5b50d9e3312ecefbbcb7c930b85a28f616e82))
* **cometnet:** make standalone lifecycle transactional ([2fa2bee](https://github.com/KyberDot/comet/commit/2fa2beef58360c7f4f39374a78b6f94e9f3f3e78))
* **cometnet:** order pool deletion state ([d5e05e2](https://github.com/KyberDot/comet/commit/d5e05e2464ea3970225452b4f641e4438acc22d2))
* **cometnet:** own background tasks ([f95d673](https://github.com/KyberDot/comet/commit/f95d6737182d6ad27d4f4fa2adc29bf9a300ef42))
* **cometnet:** own transport ping sends ([a744cb0](https://github.com/KyberDot/comet/commit/a744cb0e90345fa918278baf9880e5cf91929365))
* **cometnet:** persist pool state before publish ([fda02ee](https://github.com/KyberDot/comet/commit/fda02ee8e0ffd5abdd4ce168ef89339164618793))
* **cometnet:** persist state atomically ([e8b0136](https://github.com/KyberDot/comet/commit/e8b0136aa5c322eb346ed7071b51525846c4aca7))
* **cometnet:** preserve pending gossip ([ad95158](https://github.com/KyberDot/comet/commit/ad9515835bacf2a83d44467f88d9f65e306b8b93))
* **cometnet:** preserve trusted pool authority ([3b0c4cf](https://github.com/KyberDot/comet/commit/3b0c4cf931d7f12acc61f17dbe3aaaedf885a2a2))
* **cometnet:** publish persisted pool manifests ([2f275ad](https://github.com/KyberDot/comet/commit/2f275ad0e131c4abcb462a377415801a83a6e01c))
* **cometnet:** reject unverified duplicate relays ([98bc91b](https://github.com/KyberDot/comet/commit/98bc91b3c295d8eb0eb6289e38628c3fbe1b3c8c))
* **cometnet:** release duplicate peer slots ([9fdc57f](https://github.com/KyberDot/comet/commit/9fdc57fe82c814d834a58ce3c074df5b1e2474cb))
* **cometnet:** release per-IP slot on peer disconnect ([b7e0b3b](https://github.com/KyberDot/comet/commit/b7e0b3bf54da9929ea49d0c6dc56532e1910572a))
* **cometnet:** reserve handshake capacity ([eae70bb](https://github.com/KyberDot/comet/commit/eae70bb65049f0310fd8b2632fa17fe207cab025))
* **cometnet:** restore state transactionally ([85a0540](https://github.com/KyberDot/comet/commit/85a05405009c4b16e470538a37f57e25746b422a))
* **cometnet:** serialize invite consumption ([2573b41](https://github.com/KyberDot/comet/commit/2573b413d34dce5544ed933cf1cba15d1517524d))
* **cometnet:** serialize pool lifecycle state ([ed97af5](https://github.com/KyberDot/comet/commit/ed97af58a25a6b181aaf01fa0bd02f82fad7c8ae))
* **cometnet:** serialize pool member mutations ([0404ca4](https://github.com/KyberDot/comet/commit/0404ca4c80ddec5c189548e56c9645ce8d930d0a))
* **cometnet:** serialize remote member deltas ([0c1ae64](https://github.com/KyberDot/comet/commit/0c1ae64ad344fe2a09f7a5c4ff1083724dfe0ad7))
* **cometnet:** sign persisted node state ([141105f](https://github.com/KyberDot/comet/commit/141105f6bd3f1093159db110c81bbe3293bb9141))
* **cometnet:** surface pool storage failures ([e62eb2e](https://github.com/KyberDot/comet/commit/e62eb2e012470b812e3dc81682699e4d8181ae8c))
* **cometnet:** surface transport runtime failures ([a28104e](https://github.com/KyberDot/comet/commit/a28104eab2b271a64128fa4aa3d1192c48e60654))
* **cometnet:** validate persisted pool data ([06e36e9](https://github.com/KyberDot/comet/commit/06e36e962f07d381139b1d394de8cb19e9954654))
* **cometnet:** validate persisted pool manifests ([fb0650a](https://github.com/KyberDot/comet/commit/fb0650a8a2fd8d6c6cd843df0a3a4208fa012a38))
* **cometnet:** validate pool message content ([a4eedf6](https://github.com/KyberDot/comet/commit/a4eedf6e5600f1e1bdfb97f64496326371d56667))
* **cometnet:** validate relay batch results ([604c3ed](https://github.com/KyberDot/comet/commit/604c3ed65db4866ae4ceccc15ed27cc046f84f58))
* **cometnet:** validate signed numeric fields ([8273624](https://github.com/KyberDot/comet/commit/82736244027be2f11b2be1fdd28516c87a1ad986))
* **cometnet:** validate state before restore ([c699613](https://github.com/KyberDot/comet/commit/c699613099b82ea383d2c2e94135f4037ab7e868))
* **config:** reject invalid scraper modes ([54bedca](https://github.com/KyberDot/comet/commit/54bedca97ee4bb01295f437be8a453044420840a))
* **config:** require aligned scraper credentials ([3b39b7f](https://github.com/KyberDot/comet/commit/3b39b7f57d12703bee9e7d4a8569c3e83cd6e6e8))
* **config:** require positive worker counts ([b6d8ca9](https://github.com/KyberDot/comet/commit/b6d8ca90a1d651368928689ec0c126a84ef8eff4))
* **config:** restore saved filters and update Punjabi flag ([d75a0e5](https://github.com/KyberDot/comet/commit/d75a0e543a8a32d14f60d15813be3de9afde5674))
* **config:** restore saved filters and update Punjabi flag ([8caddf6](https://github.com/KyberDot/comet/commit/8caddf6799c21366c22c850cc30fcb7c1768231f))
* **config:** validate CometNet operation values ([c21cfb7](https://github.com/KyberDot/comet/commit/c21cfb7266fcb8acdb653d85d964b4be34e70f5a))
...
* **database:** contain replica routing failures ([097bfdd](https://github.com/KyberDot/comet/commit/097bfdde1e56c2ec6583fc6b44a819362cda07dd))
* **database:** disconnect after setup failure ([4634028](https://github.com/KyberDot/comet/commit/46340282f38541cbeebcf07e07424b89a329c0ee))
* **debrid:** close StremThru responses ([45415f0](https://github.com/KyberDot/comet/commit/45415f018c140d967c60c4ce3a97d4d7fd06b1a0))
* **debrid:** merge service enrichments deterministically ([62bc384](https://github.com/KyberDot/comet/commit/62bc3849fe380748cfe91b8da1594b43a2817084))
* **debrid:** own cache write tasks ([427f5ca](https://github.com/KyberDot/comet/commit/427f5caa489cd33c2e449167a4a6115911d9b68e))
* **debrid:** prepare availability responses once ([12da600](https://github.com/KyberDot/comet/commit/12da6003bd59922ac1a4e49d117a72ce0c0eccce))
* **debrid:** preserve duplicate account fallback ([47194a7](https://github.com/KyberDot/comet/commit/47194a7d1e0ed8d83903b17e19cdcfb5906a8314))
* **debrid:** replace account snapshots atomically ([d6c9326](https://github.com/KyberDot/comet/commit/d6c9326ad466dde6dd3ff2965e2c5d8c47019b2e))
* **debrid:** stop account sync tasks cleanly ([58ffd5d](https://github.com/KyberDot/comet/commit/58ffd5dc0a15c920ac70038225a53b263c6e9002))
* **debrid:** surface unexpected link errors ([b9cc271](https://github.com/KyberDot/comet/commit/b9cc271a28fe655ba0d63aef05f3dd21f800f5f8))
* **dependencies:** update torrent-parse-rank source reference to latest commit ([efcb4f8](https://github.com/KyberDot/comet/commit/efcb4f86684e5be45c25019636ae3588c1ac2f2a))
* **deps:** update torrent-parse-rank source to latest commit ([4f11532](https://github.com/KyberDot/comet/commit/4f11532057934ca1539fd5bf925f1b2dae2a54fc))
* **dmm:** keep failed hashlists retryable ([7833f36](https://github.com/KyberDot/comet/commit/7833f369bc2800d89da908243c9983b92efc014c))
* **dmm:** reject unsafe archive members ([980070b](https://github.com/KyberDot/comet/commit/980070b067b09d3396f9bc7002e80a922374e787))
* **docker:** remove unnecessary user creation and ownership in Dockerfile ([3cf92a4](https://github.com/KyberDot/comet/commit/3cf92a4de9b9305bb5dda0bbcac4e55779206907))
...
* **entrypoint:** propagate server startup failures ([b575549](https://github.com/KyberDot/comet/commit/b5755497705e3fe94f3d5e30276ecb22d6a359ed))
...
* **filtering:** match multi-title releases with a foreign first title ([00063cf](https://github.com/KyberDot/comet/commit/00063cf73c02a80dedd271eba5a202f7868851b6))
* **filtering:** match multi-title releases with a foreign first title ([8697e1b](https://github.com/KyberDot/comet/commit/8697e1beefe2258a73a15a0c7688c7a1553a5e27))
* **filtering:** normalize current aliases ([3ade6d7](https://github.com/KyberDot/comet/commit/3ade6d7cf229740f083bcdb84ab7eec4d0809c2a))
* **filtering:** reject empty alias matches ([5bd140c](https://github.com/KyberDot/comet/commit/5bd140c858351544fbb709ac575d4ee58e8314a2))
* **formatting:** simplify director's cut condition check ([9cb1a8a](https://github.com/KyberDot/comet/commit/9cb1a8af71c4d8a5292fae30333588771d1da0fe))
...
* **http:** enforce cache and client runtime contracts ([8650b08](https://github.com/KyberDot/comet/commit/8650b08aa47d71c5806c72e788451a398bf80540))
...
* **indexers:** close Prowlarr responses ([a3a0466](https://github.com/KyberDot/comet/commit/a3a046632e48dda96bda554367d159b761b004b9))
* **indexers:** isolate malformed health records ([fecfcf0](https://github.com/KyberDot/comet/commit/fecfcf0112d36dd30a16b7f6eeac1fd57512ea54))
* **kodi:** isolate malformed catalog metadata ([4f51b46](https://github.com/KyberDot/comet/commit/4f51b460671e96e73ed56fa2b7772ef2d33f350c))
* **kodi:** isolate malformed stream entries ([bc82536](https://github.com/KyberDot/comet/commit/bc825361944e16de80084dd68c69038567cfef79))
* **kodi:** make setup pairing first-writer wins ([90bc402](https://github.com/KyberDot/comet/commit/90bc402a13b5ae59311c37ccfad9d623d7502629))
* **kodi:** require current pairing origin ([e1880e6](https://github.com/KyberDot/comet/commit/e1880e648214f529c20b2aa61bb445a77bc3c8bd))
* **kodi:** validate pairing responses ([be75acf](https://github.com/KyberDot/comet/commit/be75acf15907dd0d3f898ea70a0064e0283a540a))
* **kodi:** validate stream metadata hints ([aff9a24](https://github.com/KyberDot/comet/commit/aff9a2462e21d79545d009baff31b1885a9f3453))
* **lifecycle:** clean partial app startup ([fb3162d](https://github.com/KyberDot/comet/commit/fb3162d8a23a48b8f226841d77d1ef0315430c16))
* **lock:** renew leases around long operations ([bf6a6e7](https://github.com/KyberDot/comet/commit/bf6a6e79b8798a0b370016ff00f470a8815e4208))
* **metadata:** commit episode index atomically ([0b317d3](https://github.com/KyberDot/comet/commit/0b317d34bf9c5506af5fbd2adf8e44239c8e872f))
* **metadata:** isolate malformed Kitsu fields ([232d374](https://github.com/KyberDot/comet/commit/232d3746fd8cabf13c14ebf208fdbcce7085083c))
* **metadata:** isolate malformed provider results ([bf6a86e](https://github.com/KyberDot/comet/commit/bf6a86ef8366920093c8f4e83a76df3191f66425))
* **metadata:** isolate malformed TMDB results ([d2d1559](https://github.com/KyberDot/comet/commit/d2d15591a8c0812be84f77ea743c76dfcdfffe8b))
* **metadata:** parse Trakt aliases deterministically ([fc2a757](https://github.com/KyberDot/comet/commit/fc2a757df68d2261ae4cb3e23cda452562b5be9f))
* **metadata:** replace stale episode index rows ([5af7397](https://github.com/KyberDot/comet/commit/5af739700f5545125bd5604573a2ec6378ce9b4a))
* **metadata:** validate cached episode dates ([aa92f4c](https://github.com/KyberDot/comet/commit/aa92f4c871a285be2229b21dfa93d782faa7ec33))
* **models:** replace random password generation with secure secret generation ([9cb1a8a](https://github.com/KyberDot/comet/commit/9cb1a8af71c4d8a5292fae30333588771d1da0fe))
...
* **playback:** isolate cache failures ([01daab7](https://github.com/KyberDot/comet/commit/01daab7f4a3302e2bdf0d88207191f6b383ad069))
* **playback:** require canonical request scope ([5106b79](https://github.com/KyberDot/comet/commit/5106b799780b0a1e6ed38ff4ec670f2454c17935))
...
* **ranking:** surface unexpected torrent errors ([ba34381](https://github.com/KyberDot/comet/commit/ba343813f7d882b06712c4fd248ef62b7194e5c4))
* **scrapers:** cancel unfinished provider tasks ([f6f06da](https://github.com/KyberDot/comet/commit/f6f06da554626669e1f926eec8ad9908b8a2efb1))
* **scrapers:** close Zilean responses ([d48a49a](https://github.com/KyberDot/comet/commit/d48a49aca9d3ee430cb2387f0dd5348899f12ceb))
* **scrapers:** isolate credential header caches ([499e92e](https://github.com/KyberDot/comet/commit/499e92ee3a034b0ddcb1954612e181885a110539))
* **scrapers:** isolate indexer result failures ([d086f10](https://github.com/KyberDot/comet/commit/d086f1021b3e9bc0cf3693534d35d8138afd9f32))
* **scrapers:** isolate malformed addon streams ([595c4ed](https://github.com/KyberDot/comet/commit/595c4ed526935e9f2b8364db4a4f686f524489fb))
* **scrapers:** isolate malformed addon streams ([044ddef](https://github.com/KyberDot/comet/commit/044ddefc89d1014637518faf6f764882994708e8))
* **scrapers:** isolate malformed Torrentio streams ([135d2e8](https://github.com/KyberDot/comet/commit/135d2e84c2f8598f3f5fd5495a901159833e733e))
* **scrapers:** keep torrent rows aligned ([dc44b9d](https://github.com/KyberDot/comet/commit/dc44b9dcb3cf79259950b049760b47edad920e87))
* **scraper:** skip invalid magnet titles in StremthruScraper ([3136b9c](https://github.com/KyberDot/comet/commit/3136b9cbe731aa8941eba0b93fe21b227e289127))
* **scrapers:** preserve valid nested results ([481853a](https://github.com/KyberDot/comet/commit/481853afda81c70b013f19dfb6515d1bae3c067e))
* **scrapers:** validate aggregate result schema ([dc6e5fc](https://github.com/KyberDot/comet/commit/dc6e5fc6be12ce6251271e2846734a25fdd251c9))
* **scraper:** update scraper type hint for better clarity ([9cb1a8a](https://github.com/KyberDot/comet/commit/9cb1a8af71c4d8a5292fae30333588771d1da0fe))
* **scripts:** publish validated status assets atomically ([93650e8](https://github.com/KyberDot/comet/commit/93650e81949cf7805fba09b4bee8e306d954f4c4))
* **series:** support aggregate searches and scoped debrid caching ([ce5cae5](https://github.com/KyberDot/comet/commit/ce5cae50a86449a40e744c81dc22eb96b7d88e12))
* **series:** support aggregate searches and scoped debrid caching ([c2d3d79](https://github.com/KyberDot/comet/commit/c2d3d79cbf2897b96cc299bb45c45535c369ff12))
...
* **storage:** durably replace state files ([8b77186](https://github.com/KyberDot/comet/commit/8b771868b24b1a7cf059c8be66a3982c440a9735))
* **streaming:** complete connection cleanup ([8e22225](https://github.com/KyberDot/comet/commit/8e22225bbbdd9d62016bcd84b09af52c624e8519))
* **streaming:** serialize connection admission ([2a59a7c](https://github.com/KyberDot/comet/commit/2a59a7c7b0ef122b45c77ceac707fb88b4d31102))
* **torrents:** isolate corrupt file entries ([aaca327](https://github.com/KyberDot/comet/commit/aaca32786f8124059abe147e494f02d8be06930d))
* **torrents:** isolate invalid persistence rows ([26bf81c](https://github.com/KyberDot/comet/commit/26bf81c615cad1b462b3077836cf8403d8fc4d14))
* **torrents:** preserve valid metadata on partial corruption ([97cc2a1](https://github.com/KyberDot/comet/commit/97cc2a1ace57626060f9f89b8f61cef0d8b5f5b6))
* **ui:** Offcloud now uses an API key, not email:password ([a1c6323](https://github.com/KyberDot/comet/commit/a1c6323e0d4ad85faa89b746fa11dafb2fcca8de))
* **ui:** Offcloud now uses an API key, not email:password ([c617a16](https://github.com/KyberDot/comet/commit/c617a16f5cb9b07e2d0642b9628a12d3d734aef4))
...
* **utils:** reject corrupt identity and size values ([1e8597b](https://github.com/KyberDot/comet/commit/1e8597b3388d08d03aaebaad3dc88ceac4d84fdb))


### Performance Improvements

* **background:** read one primary queue snapshot ([6ff5ef1](https://github.com/KyberDot/comet/commit/6ff5ef1280ad2c6bf78911ca8c526cf2998fe84b))
* **cache:** overlap independent state probes ([3bfd384](https://github.com/KyberDot/comet/commit/3bfd3843663da7346d8ec360176a476877009434))
* **cache:** overlap mapped media reads ([d06419c](https://github.com/KyberDot/comet/commit/d06419c2605342e51b71ffd0399c03d8d09fbe62))
* **cometnet:** coalesce relay batch flushes ([05d39d4](https://github.com/KyberDot/comet/commit/05d39d45f12d65c1c403a16d265f0d8d47e06344))
...
* **database:** cache migration metadata ([6506c57](https://github.com/KyberDot/comet/commit/6506c57074e300d9f352c2c06946bed1447eb77c))
* **database:** stream exports with keyset batches ([9f7b16c](https://github.com/KyberDot/comet/commit/9f7b16cf8f68cca11142f17ffa951831c10798c3))
* **debrid:** compact availability conflicts ([3282860](https://github.com/KyberDot/comet/commit/32828602866749fdbb920c48ccaa8efe42aff50c))
* **debrid:** overlap account freshness probes ([56021d0](https://github.com/KyberDot/comet/commit/56021d097e0288a29515b78c17ec67a69b727290))
* **debrid:** overlap refresh state reads ([2356fbb](https://github.com/KyberDot/comet/commit/2356fbb1870ffcc3dd416f4394a0722e7a88f08f))
* **filter:** clone only mutable parse state ([0d3799f](https://github.com/KyberDot/comet/commit/0d3799fd2e818bf62929dd6d2a6747fab919876e))
* **metadata:** coalesce concurrent refreshes ([f0b5789](https://github.com/KyberDot/comet/commit/f0b57898a5b97813dacd86e49901e3c793a01b0d))
* **ranking:** batch RTN scoring ([12416a5](https://github.com/KyberDot/comet/commit/12416a56a7dae63b29fbfdee82ea53472501b8ac))
* **ranking:** combine RTN filtering and scoring ([065be08](https://github.com/KyberDot/comet/commit/065be08c3776bb11566e14fbfb7501bd34aad519))
